...
plugins = {
  ...
  "senecajs/seneca-level-store" : {"kind":"plugin"},
  "senecajs/seneca-auth" : {"kind":"plugin"},
  "senecajs/seneca-cache" : {"kind":"plugin"},
  "senecajs/seneca-user" : {"kind":"plugin"},
  "senecajs/seneca-mesh" : {"kind":"plugin"},
  "senecajs/seneca-balance-client" : {"kind":"plugin"},
  "senecajs/seneca-redis-cache" : {"kind":"plugin"},
  "senecajs/seneca-entity-cache" : {"kind":"plugin"},
  "senecajs/seneca-cache-test" : {"kind":"plugin"},
  "senecajs/seneca-redis-pubsub-transport" : {"kind":"plugin"},
  "senecajs/seneca-redis-queue-transport" : {"kind":"plugin"},
  "senecajs/seneca-registry" : {"kind":"plugin"},
  "senecajs/seneca-jsonfile-store" : {"kind":"plugin"},
  "senecajs/seneca-pino-logger" : {"kind":"plugin"},
  "senecajs/seneca-consul-registry" : {"kind":"plugin"},
  "senecajs/seneca-redis-store" : {"kind":"plugin"},
  "senecajs/seneca-logstash-logger" : {"kind":"plugin"},
  "senecajs/seneca-logentries-logger" : {"kind":"plugin"},
  "voxgig/seneca-populate" : {"kind":"plugin"},
  "voxgig/seneca-allow" : {"kind":"plugin"},
  "voxgig/seneca-owner" : {"kind":"plugin"},
  "voxgig/seneca-member" : {"kind":"plugin"},
  ...
  "voxgig/seneca-kv" : {"kind":"plugin"},
  "voxgig/seneca-redis-kv" : {"kind":"plugin"},
  "voxgig/seneca-debug" : {"kind":"plugin"},
  "voxgig/seneca-msg-run" : {"kind":"plugin"},
  "voxgig/seneca-hapi" : {"kind":"plugin"},
  "voxgig/seneca-user-telemetry" : {"kind":"plugin"},
  "voxgig/seneca-doc" : {"kind":"plugin"},
  "senecajs-labs/seneca-sqlite-store" : {"kind":"plugin"},
  "senecajs-labs/seneca-zipkin-tracer" : {"kind":"plugin"},
  "senecajs-labs/seneca-dynamo-store" : {"kind":"plugin"},
  "senecajs-labs/seneca-hana-store" : {"kind":"plugin"},
  "senecajs-labs/seneca-shard-store" : {"kind":"plugin"},
  "senecajs-labs/seneca-store-query" : {"kind":"plugin"},
  "senecajs-labs/seneca-standard-query" : {"kind":"plugin"},
  "senecajs-labs/seneca-cluster" : {"kind":"plugin"},
  "senecajs-labs/seneca-queue" : {"kind":"plugin"},
  "senecajs-labs/seneca-quartz-scheduler" : {"kind":"plugin"},
  "senecajs-labs/seneca-cassandra-store" : {"kind":"plugin"},
  "senecajs-labs/seneca-import-csv" : {"kind":"plugin"},
  "senecajs-labs/seneca-entity-save-stream" : {"kind":"plugin"},
  "senecajs-labs/seneca-elasticsearch" : {"kind":"plugin"},
  "senecajs-labs/seneca-act-stream" : {"kind":"plugin"},
  "senecajs-labs/seneca-rabbitmq-transport" : {"kind":"plugin"}
}
